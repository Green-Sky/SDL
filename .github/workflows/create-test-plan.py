...
JOB_SPECS = {
    ...
    "android-cmake-arm32": JobSpec(name="Android arm32 (CMake)",            os=JobOs.UbuntuLatest,  platform=SdlPlatform.Android,     artifact="SDL-android-arm32",      android_abi="armeabi-v7a", android_arch="armeabi", android_platform=23, ),
